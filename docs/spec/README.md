...
4. `data-model.md`: defines durable objects and records.
5. `cli.md`: defines the first user-facing command surface.
6. `open-questions.md`: lists decisions that still need confirmation.
