...
- A narrower next experiment should target one failure mode with a falsifiable physical prior, where the prior is a bottom-level physical rule or constraint.
